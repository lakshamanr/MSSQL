...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["user-defined-data-type-user-defined-data-type-module"], {
  ...
  function _src_app_userDefinedDataType_components_userDefinedDataType_userDefinedDataTypeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /* harmony import */
    var _services_user_defined_data_type_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/user-defined-data-type.service */"./src/app/user-defined-data-type/services/user-defined-data-type.service.ts");
    /* harmony import */
      ...
      return _createClass(UserDefinedDataTypeComponent, [{
        ...
        value: function loadDetails(schemaName, typeName) {
          ...
          this.dataTypeService.getUserDefinedDataTypeDetails(schemaName, typeName).subscribe(function (data) {
            _this.selectedDataType = data;
            _this.newDescription = data.description || '';
          });
        }
      }, {
        key: "toggleEditBox",
        ...
        value: function saveDescription() {
          ...
          this.dataTypeService.upsertExtendedProperty(request).subscribe(function () {
            ...
            _this2.selectedDataType.description = _this2.newDescription;
            // Force UI update
            _this2.ngZone.run(function () {
              _this2.iblnShowEditBox = false;
              _this2.cdRef.detectChanges(); // Ensures Angular updates UI
            });
          }, function (error) {
      ...
      return _createClass(UserDefinedDataTypesComponent, [{
        ...
        value: function loadDataTypes() {
          ...
          this.dataTypeService.getAllUserDefinedDataTypes().subscribe(function (data) {
            _this3.userDefinedDataTypes = data;
          });
        }
        // TrackBy function for better performance
      }, {
        key: "trackByTypeName",
        value: function trackByTypeName(index, dataType) {
  ...
  function _src_app_userDefinedDataType_services_userDefinedDataTypeServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var UserDefinedDataTypeService = /*#__PURE__*/function () {
      function UserDefinedDataTypeService(http, primaryUrl) {
  ...
  /***/
  function _src_app_userDefinedDataType_userDefinedDataTypeModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /* harmony import */
    var _components_user_defined_data_type_user_defined_data_type_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/user-defined-data-type/user-defined-data-type.component */"./src/app/user-defined-data-type/components/user-defined-data-type/user-defined-data-type.component.ts");
    /* harmony import */
    var _components_user_defined_data_types_user_defined_data_types_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/user-defined-data-types/user-defined-data-types.component */"./src/app/user-defined-data-type/components/user-defined-data-types/user-defined-data-types.component.ts");
    /* harmony import */
    var _services_user_defined_data_type_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./services/user-defined-data-type.service */"./src/app/user-defined-data-type/services/user-defined-data-type.service.ts");
    /* harmony import */
    ...
    /* harmony import */
    var _angular_common_http__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @angular/common/http */"./node_modules/@angular/common/fesm2015/http.js");
    /* harmony import */
    ...
    UserDefinedDataTypesModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      _angular_common_http__WEBPACK_IMPORTED_MODULE_19__["HttpClientModule"], /* PrimeNG Modules */
...
//# sourceMappingURL=user-defined-data-type-user-defined-data-type-module-es5.js.map