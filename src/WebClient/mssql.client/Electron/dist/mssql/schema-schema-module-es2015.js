(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["schema-schema-module"],{
...
let SchemasComponent = class SchemasComponent {
    ...
    trackBySchemaName(index, schema) {
...
/***/ "./src/app/schema/schema.module.ts":
/*!*****************************************!*\
  !*** ./src/app/schema/schema.module.ts ***!
  \*****************************************/
...
const routes = [
    { path: 's', component: _components_schemas_schemas_component__WEBPACK_IMPORTED_MODULE_5__["SchemasComponent"] },
    { path: ':objectname', component: _components_schema_schema_component__WEBPACK_IMPORTED_MODULE_4__["SchemaComponent"] }
];
...
let SchemaService = class SchemaService {
    ...
    getSchemaMetadata(schemaName) {
        return this.http.get(`${this.primaryUrl}/metadata/${schemaName}`);
    }
};
...
//# sourceMappingURL=schema-schema-module-es2015.js.map