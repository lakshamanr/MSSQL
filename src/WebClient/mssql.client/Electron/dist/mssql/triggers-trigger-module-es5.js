...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["triggers-trigger-module"], {
  ...
  /***/
  function _node_modules_primeng_fesm2015_primengCardJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function _node_modules_primeng_fesm2015_primengInputtextJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function _src_app_triggers_components_databaseTrigger_databaseTriggerComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DatabaseTriggerComponent = /*#__PURE__*/function () {
      function DatabaseTriggerComponent(route, router, triggerService, messageService) {
      ...
      return _createClass(DatabaseTriggerComponent, [{
        ...
        key: "setupBreadcrumb",
        value: function setupBreadcrumb() {
          this.breadcrumbItems = [{
            label: 'Triggers',
            routerLink: '/Trigger/s'
          }, {
        ...
        value: function getTriggerByName(name) {
          ...
          this.triggerService.getTriggerByName(name).subscribe({
            next: function next(data) {
              ...
              _this.tiggersDesc = _this.selectedTrigger ? _this.selectedTrigger.description || '' : '';
              _this.loading = false;
            },
            error: function error(_error) {
              console.error('Error fetching trigger:', _error);
              _this.loading = false;
        ...
        value: function SaveTableMsDesciption(event) {
          ...
          this.triggerService.mergeTriggerProperty(this.selectedTrigger).subscribe({
            ...
            error: function error(_error2) {
              console.error('Error updating trigger description:', _error2);
              _this2.saving = false;
              _this2.messageService.add({
                severity: 'error',
                summary: 'Error',
  ...
  function _src_app_triggers_components_databaseTriggers_databaseTriggersComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DatabaseTriggersComponent = /*#__PURE__*/function () {
      function DatabaseTriggersComponent(triggerService, messageService) {
      ...
      return _createClass(DatabaseTriggersComponent, [{
        ...
        value: function getAllTriggers() {
          ...
          this.triggerService.getAllTriggers().subscribe({
            ...
            error: function error(_error3) {
              console.error('Error fetching triggers:', _error3);
              _this3.loading = false;
              _this3.messageService.add({
                severity: 'error',
                summary: 'Error',
        ...
        key: "trackByName",
        value: function trackByName(index, trigger) {
          return trigger.name;
        }
      }]);
    }();
  ...
  function _src_app_triggers_services_databaseTriggerServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DatabaseTriggerService = /*#__PURE__*/function () {
      function DatabaseTriggerService(http, primaryUrl, secondaryUrl) {
  ...
  /***/
  function _src_app_triggers_triggerModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /* harmony import */
    var primeng_card__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! primeng/card */"./node_modules/primeng/fesm2015/primeng-card.js");
    /* harmony import */
    var primeng_inputtext__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! primeng/inputtext */"./node_modules/primeng/fesm2015/primeng-inputtext.js");
    /* harmony import */
    var primeng_tooltip__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! primeng/tooltip */"./node_modules/primeng/fesm2015/primeng-tooltip.js");
    /* harmony import */
    var primeng_api__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! primeng/api */"./node_modules/primeng/fesm2015/primeng-api.js");
    /* harmony import */
    var _services_database_trigger_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./services/database-trigger.service */"./src/app/triggers/services/database-trigger.service.ts");
    /* harmony import */
    ...
    /* harmony import */
    var _shared_shared_module__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ../shared/shared.module */"./src/app/shared/shared.module.ts");
...
//# sourceMappingURL=triggers-trigger-module-es5.js.map