...
let DatabaseTriggerComponent = class DatabaseTriggerComponent {
    constructor(route, triggerService) {
        this.route = route;
    ...
    getTriggerByName(name) {
        this.triggerService.getTriggerByName(name).subscribe((data) => { this.selectedTrigger = data; this.tiggersDesc = this.selectedTrigger.description; }, (error) => console.error('Error fetching trigger:', error));
    }
    ...
    SaveTableMsDesciption(event) {
        ...
        this.triggerService.mergeTriggerProperty(this.selectedTrigger).subscribe((message) => {
            console.log(message);
            this.iblnShowEditBox = false;
            this.getTriggerByName(this.tiggersName);
...
let DatabaseTriggersComponent = class DatabaseTriggersComponent {
    ...
    getAllTriggers() {
        this.triggerService.getAllTriggers().subscribe((data) => this.triggers = data, (error) => console.error('Error fetching triggers:', error));
    }
};
...
/* harmony import */ var amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! amexio-ng-extensions */ "./node_modules/amexio-ng-extensions/amexio-ng-extensions.js");
...
/* harmony import */ var _services_database_trigger_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./services/database-trigger.service */ "./src/app/Triggers/services/database-trigger.service.ts");
...
DatabaseTriggerModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            _angular_router__WEBPACK_IMPORTED_MODULE_21__["RouterModule"].forRoot(appRoutes, { useHash: true }),
            /* Core Modules */
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
            _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"],
            /* Amexio Modules */
            amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_7__["AmexioDataModule"],
            amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_7__["AmexioWidgetModule"],
            amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_7__["AmexioChartsModule"],
...
let DatabaseTriggerService = class DatabaseTriggerService {
    ...
    getAllTriggers() {
        ...
        return this.http.get(`${this.primaryUrl}`, { headers });
    }
    getTriggerByName(name) {
        const headers = this.getAuthHeaders();
        return this.http.get(`${this.primaryUrl}/${name}`, { headers });
    }
    mergeTriggerProperty(trigger) {
        const headers = this.getAuthHeaders();
        return this.http.post(`${this.primaryUrl}`, trigger, { headers });
    }
};
...
let UserDefinedDataTypeService = class UserDefinedDataTypeService {
    ...
    getAllUserDefinedDataTypes() {
        const headers = this.getAuthHeaders();
        return this.http.get(`${this.primaryUrl}/all`, { headers });
    }
    getUserDefinedDataTypeDetails(schemaName, typeName) {
        const headers = this.getAuthHeaders();
        return this.http.get(`${this.primaryUrl}/details/${schemaName}/${typeName}`, { headers });
    }
    upsertExtendedProperty(request) {
        const headers = this.getAuthHeaders();
        return this.http.post(`${this.primaryUrl}/upsert-extended-property`, request, { headers });
    }
};
...
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm2015/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _components_user_defined_data_type_user_defined_data_type_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/user-defined-data-type/user-defined-data-type.component */ "./src/app/UserDefinedDataType/components/user-defined-data-type/user-defined-data-type.component.ts");
...
/* harmony import */ var _services_user_defined_data_type_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./services/user-defined-data-type.service */ "./src/app/UserDefinedDataType/services/user-defined-data-type.service.ts");
/* harmony import */ var amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! amexio-ng-extensions */ "./node_modules/amexio-ng-extensions/amexio-ng-extensions.js");
/* harmony import */ var primeng_accordion__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! primeng/accordion */ "./node_modules/primeng/fesm2015/primeng-accordion.js");
/* harmony import */ var primeng_table__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! primeng/table */ "./node_modules/primeng/fesm2015/primeng-table.js");
/* harmony import */ var primeng_tree__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! primeng/tree */ "./node_modules/primeng/fesm2015/primeng-tree.js");
...
/* harmony import */ var amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! amexio-ng-extensions */ "./node_modules/amexio-ng-extensions/amexio-ng-extensions.js");
...
XmlSchemaModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            /* Amexio Modules */
            amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_8__["AmexioDataModule"],
            amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_8__["AmexioWidgetModule"],
            amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_8__["AmexioChartsModule"],
            amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_8__["AmexioEnterpriseModule"],
            /* PrimeNG Modules */
...
/* harmony import */ var angular_split__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! angular-split */ "./node_modules/angular-split/fesm2015/angular-split.js");
/* harmony import */ var _ngx_prism_core__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @ngx-prism/core */ "./node_modules/@ngx-prism/core/dist/index.js");
/* harmony import */ var primeng_accordion__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! primeng/accordion */ "./node_modules/primeng/fesm2015/primeng-accordion.js");
...
/* harmony import */ var primeng_codehighlighter__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! primeng/codehighlighter */ "./node_modules/primeng/fesm2015/primeng-codehighlighter.js");
/* harmony import */ var primeng_contextmenu__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! primeng/contextmenu */ "./node_modules/primeng/fesm2015/primeng-contextmenu.js");
...
/* harmony import */ var primeng_tabview__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! primeng/tabview */ "./node_modules/primeng/fesm2015/primeng-tabview.js");
/* harmony import */ var primeng_toast__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! primeng/toast */ "./node_modules/primeng/fesm2015/primeng-toast.js");
/* harmony import */ var primeng_tree__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! primeng/tree */ "./node_modules/primeng/fesm2015/primeng-tree.js");
/* harmony import */ var amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! amexio-ng-extensions */ "./node_modules/amexio-ng-extensions/amexio-ng-extensions.js");
/* harmony import */ var ngx_ui_loader__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ngx-ui-loader */ "./node_modules/ngx-ui-loader/fesm2015/ngx-ui-loader.js");
...
/* harmony import */ var _ui_header_header_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./ui/header/header.component */ "./src/app/ui/header/header.component.ts");
/* harmony import */ var _ui_footer_footer_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./ui/footer/footer.component */ "./src/app/ui/footer/footer.component.ts");
/* harmony import */ var _ui_main_page_main_page_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./ui/main-page/main-page.component */ "./src/app/ui/main-page/main-page.component.ts");
/* harmony import */ var _left_menu_components_leftmenu_leftmenu_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./left-menu/components/leftmenu/leftmenu.component */ "./src/app/left-menu/components/leftmenu/leftmenu.component.ts");
/* harmony import */ var _database_components_database_selector_database_selector_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./database/components/database-selector/database-selector.component */ "./src/app/database/components/database-selector/database-selector.component.ts");
/* harmony import */ var _table_tables_module__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./table/tables.module */ "./src/app/table/tables.module.ts");
/* harmony import */ var _database_database_module__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./database/database.module */ "./src/app/database/database.module.ts");
/* harmony import */ var _procedure_procedure_module__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./procedure/procedure.module */ "./src/app/procedure/procedure.module.ts");
...
/* harmony import */ var _UserDefinedDataType_user_defined_data_types_module__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./UserDefinedDataType/user-defined-data-types.module */ "./src/app/UserDefinedDataType/user-defined-data-types.module.ts");
/* harmony import */ var _Triggers_database_trigger_module__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./Triggers/database-trigger.module */ "./src/app/Triggers/database-trigger.module.ts");
/* harmony import */ var _XmlSchema_xml_schema_module__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./XmlSchema/xml-schema.module */ "./src/app/XmlSchema/xml-schema.module.ts");
/* harmony import */ var _schema_schemas_module__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ./schema/schemas.module */ "./src/app/schema/schemas.module.ts");
/* harmony import */ var _auth_auth_module__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! ./auth/auth.module */ "./src/app/auth/auth.module.ts");
/* harmony import */ var _auth_interceptors_auth_interceptor__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! ./auth/interceptors/auth.interceptor */ "./src/app/auth/interceptors/auth.interceptor.ts");
/* harmony import */ var _auth_components_login_login_component__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(/*! ./auth/components/login/login.component */ "./src/app/auth/components/login/login.component.ts");
/* harmony import */ var _auth_guards_auth_guard__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(/*! ./auth/guards/auth.guard */ "./src/app/auth/guards/auth.guard.ts");
/* harmony import */ var _table_components_tables_tables_component__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(/*! ./table/components/tables/tables.component */ "./src/app/table/components/tables/tables.component.ts");
/* harmony import */ var _table_components_table_table_component__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(/*! ./table/components/table/table.component */ "./src/app/table/components/table/table.component.ts");
/* harmony import */ var _procedure_components_procedures_procedures_component__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! ./procedure/components/procedures/procedures.component */ "./src/app/procedure/components/procedures/procedures.component.ts");
/* harmony import */ var _procedure_components_procedure_procedure_component__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(/*! ./procedure/components/procedure/procedure.component */ "./src/app/procedure/components/procedure/procedure.component.ts");
/* harmony import */ var _view_components_views_views_component__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(/*! ./view/components/views/views.component */ "./src/app/view/components/views/views.component.ts");
/* harmony import */ var _view_components_view_view_component__WEBPACK_IMPORTED_MODULE_51__ = __webpack_require__(/*! ./view/components/view/view.component */ "./src/app/view/components/view/view.component.ts");
/* harmony import */ var _function_component_aggregate_functions_aggregate_functions_component__WEBPACK_IMPORTED_MODULE_52__ = __webpack_require__(/*! ./function/component/aggregate-functions/aggregate-functions.component */ "./src/app/function/component/aggregate-functions/aggregate-functions.component.ts");
/* harmony import */ var _function_component_aggregate_function_aggregate_function_component__WEBPACK_IMPORTED_MODULE_53__ = __webpack_require__(/*! ./function/component/aggregate-function/aggregate-function.component */ "./src/app/function/component/aggregate-function/aggregate-function.component.ts");
/* harmony import */ var _function_component_scalar_functions_scalar_functions_component__WEBPACK_IMPORTED_MODULE_54__ = __webpack_require__(/*! ./function/component/scalar-functions/scalar-functions.component */ "./src/app/function/component/scalar-functions/scalar-functions.component.ts");
/* harmony import */ var _function_component_scalar_function_scalar_function_component__WEBPACK_IMPORTED_MODULE_55__ = __webpack_require__(/*! ./function/component/scalar-function/scalar-function.component */ "./src/app/function/component/scalar-function/scalar-function.component.ts");
/* harmony import */ var _function_component_table_value_functions_table_value_functions_component__WEBPACK_IMPORTED_MODULE_56__ = __webpack_require__(/*! ./function/component/table-value-functions/table-value-functions.component */ "./src/app/function/component/table-value-functions/table-value-functions.component.ts");
/* harmony import */ var _function_component_table_value_function_table_value_function_component__WEBPACK_IMPORTED_MODULE_57__ = __webpack_require__(/*! ./function/component/table-value-function/table-value-function.component */ "./src/app/function/component/table-value-function/table-value-function.component.ts");
/* harmony import */ var _Triggers_components_database_triggers_database_triggers_component__WEBPACK_IMPORTED_MODULE_58__ = __webpack_require__(/*! ./Triggers/components/database-triggers/database-triggers.component */ "./src/app/Triggers/components/database-triggers/database-triggers.component.ts");
/* harmony import */ var _Triggers_components_database_trigger_database_trigger_component__WEBPACK_IMPORTED_MODULE_59__ = __webpack_require__(/*! ./Triggers/components/database-trigger/database-trigger.component */ "./src/app/Triggers/components/database-trigger/database-trigger.component.ts");
/* harmony import */ var _schema_components_schemas_schemas_component__WEBPACK_IMPORTED_MODULE_60__ = __webpack_require__(/*! ./schema/components/schemas/schemas.component */ "./src/app/schema/components/schemas/schemas.component.ts");
/* harmony import */ var _schema_components_schema_schema_component__WEBPACK_IMPORTED_MODULE_61__ = __webpack_require__(/*! ./schema/components/schema/schema.component */ "./src/app/schema/components/schema/schema.component.ts");
/* harmony import */ var _XmlSchema_component_xml_schema_list_xml_schema_list_component__WEBPACK_IMPORTED_MODULE_62__ = __webpack_require__(/*! ./XmlSchema/component/xml-schema-list/xml-schema-list.component */ "./src/app/XmlSchema/component/xml-schema-list/xml-schema-list.component.ts");
/* harmony import */ var _XmlSchema_component_xml_schema_details_xml_schema_details_component__WEBPACK_IMPORTED_MODULE_63__ = __webpack_require__(/*! ./XmlSchema/component/xml-schema-details/xml-schema-details.component */ "./src/app/XmlSchema/component/xml-schema-details/xml-schema-details.component.ts");
/* harmony import */ var _UserDefinedDataType_components_user_defined_data_types_user_defined_data_types_component__WEBPACK_IMPORTED_MODULE_64__ = __webpack_require__(/*! ./UserDefinedDataType/components/user-defined-data-types/user-defined-data-types.component */ "./src/app/UserDefinedDataType/components/user-defined-data-types/user-defined-data-types.component.ts");
/* harmony import */ var _UserDefinedDataType_components_user_defined_data_type_user_defined_data_type_component__WEBPACK_IMPORTED_MODULE_65__ = __webpack_require__(/*! ./UserDefinedDataType/components/user-defined-data-type/user-defined-data-type.component */ "./src/app/UserDefinedDataType/components/user-defined-data-type/user-defined-data-type.component.ts");
/* harmony import */ var _database_components_database_details_database_details_component__WEBPACK_IMPORTED_MODULE_66__ = __webpack_require__(/*! ./database/components/database-details/database-details.component */ "./src/app/database/components/database-details/database-details.component.ts");
/* harmony import */ var _shared_shared_module__WEBPACK_IMPORTED_MODULE_67__ = __webpack_require__(/*! ./shared/shared.module */ "./src/app/shared/shared.module.ts");
...
const appRoutes = [
    ...
    // Main protected area with child routes
    {
        ...
        children: [
            { path: 'Tables', component: _table_components_tables_tables_component__WEBPACK_IMPORTED_MODULE_46__["TablesComponent"] },
            { path: 'Table/:objectname', component: _table_components_table_table_component__WEBPACK_IMPORTED_MODULE_47__["TableComponent"] },
            { path: 'Storeprocedures', component: _procedure_components_procedures_procedures_component__WEBPACK_IMPORTED_MODULE_48__["ProceduresComponent"] },
            { path: 'Storeprocedure/:objectname', component: _procedure_components_procedure_procedure_component__WEBPACK_IMPORTED_MODULE_49__["ProcedureComponent"] },
            { path: 'Views', component: _view_components_views_views_component__WEBPACK_IMPORTED_MODULE_50__["ViewsComponent"] },
            { path: 'View/:objectname', component: _view_components_view_view_component__WEBPACK_IMPORTED_MODULE_51__["ViewComponent"] },
            { path: 'AggregateFunctions', component: _function_component_aggregate_functions_aggregate_functions_component__WEBPACK_IMPORTED_MODULE_52__["AggregateFunctionsComponent"] },
            { path: 'AggregateFunction/:objectname', component: _function_component_aggregate_function_aggregate_function_component__WEBPACK_IMPORTED_MODULE_53__["AggregateFunctionComponent"] },
            { path: 'ScalarFunctions', component: _function_component_scalar_functions_scalar_functions_component__WEBPACK_IMPORTED_MODULE_54__["ScalarFunctionsComponent"] },
            { path: 'ScalarFunction/:objectname', component: _function_component_scalar_function_scalar_function_component__WEBPACK_IMPORTED_MODULE_55__["ScalarFunctionComponent"] },
            { path: 'TableValueFunctions', component: _function_component_table_value_functions_table_value_functions_component__WEBPACK_IMPORTED_MODULE_56__["TableValueFunctionsComponent"] },
            { path: 'TableValueFunction/:objectname', component: _function_component_table_value_function_table_value_function_component__WEBPACK_IMPORTED_MODULE_57__["TableValueFunctionComponent"] },
            { path: 'Triggers', component: _Triggers_components_database_triggers_database_triggers_component__WEBPACK_IMPORTED_MODULE_58__["DatabaseTriggersComponent"] },
            { path: 'Trigger/:objectname', component: _Triggers_components_database_trigger_database_trigger_component__WEBPACK_IMPORTED_MODULE_59__["DatabaseTriggerComponent"] },
            { path: 'Schemas', component: _schema_components_schemas_schemas_component__WEBPACK_IMPORTED_MODULE_60__["SchemasComponent"] },
            { path: 'Schema/:objectname', component: _schema_components_schema_schema_component__WEBPACK_IMPORTED_MODULE_61__["SchemaComponent"] },
            { path: 'XmlSchemas', component: _XmlSchema_component_xml_schema_list_xml_schema_list_component__WEBPACK_IMPORTED_MODULE_62__["XmlSchemaListComponent"] },
            { path: 'XmlSchema/:objectname', component: _XmlSchema_component_xml_schema_details_xml_schema_details_component__WEBPACK_IMPORTED_MODULE_63__["XmlSchemaDetailsComponent"] },
            { path: 'UserDefinedDataTypes', component: _UserDefinedDataType_components_user_defined_data_types_user_defined_data_types_component__WEBPACK_IMPORTED_MODULE_64__["UserDefinedDataTypesComponent"] },
            { path: 'UserDefinedDataType/:objectname', component: _UserDefinedDataType_components_user_defined_data_type_user_defined_data_type_component__WEBPACK_IMPORTED_MODULE_65__["UserDefinedDataTypeComponent"] },
            { path: 'Database', component: _database_components_database_details_database_details_component__WEBPACK_IMPORTED_MODULE_66__["DatabaseDetailsComponent"] },
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        declarations: [
            ...
            _ui_header_header_component__WEBPACK_IMPORTED_MODULE_28__["HeaderComponent"],
            _ui_footer_footer_component__WEBPACK_IMPORTED_MODULE_29__["FooterComponent"],
            _ui_main_page_main_page_component__WEBPACK_IMPORTED_MODULE_30__["MainPageComponent"],
            _left_menu_components_leftmenu_leftmenu_component__WEBPACK_IMPORTED_MODULE_31__["LeftmenuComponent"],
            _database_components_database_selector_database_selector_component__WEBPACK_IMPORTED_MODULE_32__["DatabaseSelectorComponent"],
        ],
        imports: [
            ...
            // Amexio Modules
            amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_24__["AmexioDataModule"],
            amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_24__["AmexioWidgetModule"],
            amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_24__["AmexioChartsModule"],
            amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_24__["AmexioEnterpriseModule"],
            // PrimeNG Modules
            ...
            primeng_codehighlighter__WEBPACK_IMPORTED_MODULE_16__["CodeHighlighterModule"],
            primeng_contextmenu__WEBPACK_IMPORTED_MODULE_17__["ContextMenuModule"],
            ...
            _ngx_prism_core__WEBPACK_IMPORTED_MODULE_12__["PrismModule"],
            angular_progress_bar__WEBPACK_IMPORTED_MODULE_19__["ProgressBarModule"],
            // NGX-UI-Loader
            ngx_ui_loader__WEBPACK_IMPORTED_MODULE_25__["NgxUiLoaderModule"].forRoot(ngxUiLoaderConfig),
            ngx_ui_loader__WEBPACK_IMPORTED_MODULE_25__["NgxUiLoaderHttpModule"],
            // Shared Module
            ...
            _table_tables_module__WEBPACK_IMPORTED_MODULE_33__["TablesModule"],
            _database_database_module__WEBPACK_IMPORTED_MODULE_34__["DatabaseModule"],
            _procedure_procedure_module__WEBPACK_IMPORTED_MODULE_35__["ProcedureModule"],
            _function_function_module__WEBPACK_IMPORTED_MODULE_36__["FunctionModule"],
            _UserDefinedDataType_user_defined_data_types_module__WEBPACK_IMPORTED_MODULE_38__["UserDefinedDataTypesModule"],
            _Triggers_database_trigger_module__WEBPACK_IMPORTED_MODULE_39__["DatabaseTriggerModule"],
            _XmlSchema_xml_schema_module__WEBPACK_IMPORTED_MODULE_40__["XmlSchemaModule"],
            _schema_schemas_module__WEBPACK_IMPORTED_MODULE_41__["SchemasModule"],
            _auth_auth_module__WEBPACK_IMPORTED_MODULE_42__["AuthModule"],
            // Routing - MUST BE LAST
            _angular_router__WEBPACK_IMPORTED_MODULE_26__["RouterModule"].forRoot(appRoutes, { useHash: true })
        ],
        providers: [
            ...
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HTTP_INTERCEPTORS"], useClass: _auth_interceptors_auth_interceptor__WEBPACK_IMPORTED_MODULE_43__["AuthInterceptor"], multi: true },
            primeng_api__WEBPACK_IMPORTED_MODULE_18__["TreeDragDropService"],
            primeng_api__WEBPACK_IMPORTED_MODULE_18__["MessageService"]
        ],
...
/* harmony import */ var _guards_auth_guard__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./guards/auth.guard */ "./src/app/auth/guards/auth.guard.ts");
/* harmony import */ var _interceptors_auth_interceptor__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./interceptors/auth.interceptor */ "./src/app/auth/interceptors/auth.interceptor.ts");
...
let AuthInterceptor = class AuthInterceptor {
    ...
    addTokenAndSecurityHeaders(request, token) {
        return request.clone({
            setHeaders: {
                Authorization: `Bearer ${token}`,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SchemaEnums", function() { return SchemaEnums; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _services_schema_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/schema.service */ "./src/app/schema/services/schema.service.ts");




let SchemaComponent = class SchemaComponent {
    constructor(route, schemaService) {
        this.route = route;
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_schema_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/schema.service */ "./src/app/schema/services/schema.service.ts");



let SchemasComponent = class SchemasComponent {
...
SchemasComponent.ctorParameters = () => [
    { type: _services_schema_service__WEBPACK_IMPORTED_MODULE_2__["SchemaService"] }
];
SchemasComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SchemasModule", function() { return SchemasModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm2015/common.js");
/* harmony import */ var _services_schema_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/schema.service */ "./src/app/schema/services/schema.service.ts");
/* harmony import */ var _components_schema_schema_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/schema/schema.component */ "./src/app/schema/components/schema/schema.component.ts");
/* harmony import */ var _components_schemas_schemas_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/schemas/schemas.component */ "./src/app/schema/components/schemas/schemas.component.ts");
/* harmony import */ var amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! amexio-ng-extensions */ "./node_modules/amexio-ng-extensions/amexio-ng-extensions.js");
...
SchemasModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            _angular_router__WEBPACK_IMPORTED_MODULE_16__["RouterModule"].forRoot(appRoutes, { useHash: true }),
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
            amexio_ng_extensions__WEBPACK_IMPORTED_MODULE_6__["AmexioDataModule"],
...
let SchemaService = class SchemaService {
    ...
    getSchemaMetadata(schemaName) {
        const headers = this.getAuthHeaders();
        return this.http.get(`${this.primaryUrl}/metadata/${schemaName}`, { headers });
    }
    getAuthHeaders() {
        const token = this.authService.getToken();
        if (!token) {
...
CodeViewerComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
...
/* harmony import */ var _components_code_viewer_code_viewer_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/code-viewer/code-viewer.component */ "./src/app/shared/components/code-viewer/code-viewer.component.ts");
...
SharedModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _components_code_viewer_code_viewer_component__WEBPACK_IMPORTED_MODULE_4__["CodeViewerComponent"]
        ],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _service_table_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../service/table.service */ "./src/app/table/service/table.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
...
let TablesComponent = class TablesComponent {
    ...
    loadTablesMetadata() {
        ...
        // Try the primary URL
        this.http.get(primaryUrl, { headers }).subscribe((result) => {
...
let TableService = class TableService {
    constructor(primaryUrl, secondaryUrl, http, authService, router) {
        this.primaryUrl = primaryUrl;
        this.secondaryUrl = secondaryUrl;
        this.http = http;
        this.authService = authService;
    ...
    loadTableMetadata(tableName) {
        ...
        const primaryRequest = this.http.get(primaryUrl, { headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(2) // Retry the primary request up to 2 times before failing over
        );
        const secondaryRequest = this.http.get(secondaryUrl, { headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(2) // Optionally retry the secondary request as well
        );
...
/* harmony import */ var _ngx_prism_core__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @ngx-prism/core */ "./node_modules/@ngx-prism/core/dist/index.js");
...
/* harmony import */ var _components_table_edit_description_dialog_edit_description_dialog_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./components/table/edit-description-dialog/edit-description-dialog.component */ "./src/app/table/components/table/edit-description-dialog/edit-description-dialog.component.ts");
/* harmony import */ var _components_table_edit_column_description_dialog_edit_column_description_dialog_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./components/table/edit-column-description-dialog/edit-column-description-dialog.component */ "./src/app/table/components/table/edit-column-description-dialog/edit-column-description-dialog.component.ts");
/* harmony import */ var _components_table_sql_script_viewer_sql_script_viewer_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./components/table/sql-script-viewer/sql-script-viewer.component */ "./src/app/table/components/table/sql-script-viewer/sql-script-viewer.component.ts");
/* harmony import */ var _service_table_service__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./service/table.service */ "./src/app/table/service/table.service.ts");
/* harmony import */ var _service_tables_service__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./service/tables.service */ "./src/app/table/service/tables.service.ts");
...
TablesModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            primeng_dialog__WEBPACK_IMPORTED_MODULE_17__["DialogModule"],
            primeng_inputtextarea__WEBPACK_IMPORTED_MODULE_18__["InputTextareaModule"],
            _ngx_prism_core__WEBPACK_IMPORTED_MODULE_20__["PrismModule"]
        ],
...
let ViewService = class ViewService {
    ...
    getAllViewData() {
        const headers = this.getAuthHeaders();
        return this.http.get(`${this.primaryUrl}/View/GetAllViewData`, { headers });
    }
    getViewMetaData(viewname) {
        const headers = this.getAuthHeaders();
        return this.http.get(`${this.primaryUrl}/View/GetViewMetaData${viewname}`, { headers });
    }
    getAuthHeaders() {
        const token = this.authService.getToken();
        if (!token) {
