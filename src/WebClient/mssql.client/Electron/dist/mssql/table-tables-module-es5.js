...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["table-tables-module"], {
      ...
      return _createClass(TablesComponent, [{
        ...
        value: function loadTablesMetadata() {
          ...
          this.http.get(primaryUrl, {
            ...
            _this4.handleLoadSuccess(result);
            _this4.isLoading = false;
          }, function (error) {
            console.error('Primary URL failed, trying secondary URL:', error);
            _this4.isLoading = false;
            _this4.http.get(secondaryUrl).subscribe(function (secondaryResult) {
              return _this4.handleLoadSuccess(secondaryResult);
            }, function (secondaryError) {
              return _this4.handleLoadError(secondaryError);
            });
          });
        }
      }, {
  ...
  function _src_app_table_tablesModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /* harmony import */
    var _service_table_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./service/table.service */"./src/app/table/service/table.service.ts");
    /* harmony import */
    var _service_tables_service__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./service/tables.service */"./src/app/table/service/tables.service.ts");
    /* harmony import */
